...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Funix\My project\Nam Project\python\Graphhoppermap'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Funix\My project\Nam Project\python\Graphhoppermap\Scripts\deactivate.nu'
